  ...
  return (
    <div className="body">
      ...
      <section>
        ...
        {/* terminação da descriçao  o nomes e os icons  */}
      </section>
      {/* terminação da seção*/}
      <main>
        <div class="a">
          ...
          <div className="projetos">
            <nav class="nav">
              ...
              <a href="#">Respondidas</a> <a href="#">Rank</a>
            </nav>
            <div class="historico">

              <div class="duvida">
                <a id="titulo" href="#">dúvida 1</a>
                <p>html é linguagem de programação !</p>
                <div class="enquetes">
      ...
      {/* terminação do main o corpo do site */}
    </div>
  );
};
